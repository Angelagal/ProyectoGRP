...
<tr>
  <td style="vertical-align: top; width: 35%;">
	...
	<@displayReportGroup group="CONAC_CONTABLES" nameOnly=true>
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3AContables%3AEF1.prpt/viewer" target="_blank">${uiLabelMap.EF1}</a></li>
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3AContables%3AEF2.prpt/viewer" target="_blank">${uiLabelMap.EF2}</a></li>
		...
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3AContables%3AEF4%20Estado%20de%20cambios%20en%20la%20situaci%C3%B3n%20financiera.prpt/viewer" target="_blank">${uiLabelMap.AccountingEF4}</a></li>
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3AContables%3AEF5%2BEstado%2Bde%2BVariaci%25C3%25B3n%2Ben%2Bla%2BHacienda%2BPublica.prpt/viewer" target="_blank">${uiLabelMap.EF5Conac}</a></li>
		...
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3AContables%3AEF7%2BEstado%2BAnal%25C3%2583%25C2%25ADtico%2Bde%2Bla%2BDeuda%2By%2BOtros%2BPasivos.prpt/viewer" target="_blank">${uiLabelMap.EF7}</a></li>
	</@displayReportGroup>		
    <@displayReportGroup group="CONAC_PRESUPUESTALES" nameOnly=true>
		...
		<li><a href="http://localhost:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3APresupuestales%3AEAEPXCA.prpt/viewer" target="_blank">${uiLabelMap.AccountingEAEPXCA}</a></li>
