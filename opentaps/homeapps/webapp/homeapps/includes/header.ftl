...
<html xmlns="http://www.w3.org/1999/xhtml">
	<#if userLogin?exists>
				...
				<nav>
					<ul>
						<li>
							...
							<a href="http://localhost/control/login">Inicio</a>
						</li>
						<li>
							...
							<a href="http://localhost/financials/control/main<#if externalKeyParam?exists>?${externalKeyParam}</#if>">Finanzas: Control Presupuestal, Contabilidad y Tesorer&iacute;a</a>
						</li>
						<li>
							...
							<a href="http://localhost/partymgr/control/main<#if externalKeyParam?exists>?${externalKeyParam}</#if>">Administraci&oacute;n del Sistema</a>
						</li>
						<li>
							...
							<a href="http://localhost/dataimport/control/main<#if externalKeyParam?exists>?${externalKeyParam}</#if>">Importaci&oacute;n de Datos</a>
						</li>
						<li>
						...
						<li>
							...
							<a href="http://localhost/webtools/control/main<#if externalKeyParam?exists>?${externalKeyParam}</#if>">Herramientas Web</a>
						</li>
						<li>
							<form class="logout" id="logout" method="post" action="<@ofbizUrl>logout${previousParams?if_exists}</@ofbizUrl>">
								...
								<input style="" class="decorativeSubmit1" type="submit"  value="${uiLabelMap.CommonLogout}" />
							</form>
			...
			<style>
				.gwtWidget, .insideHeaderText, .logo-area, .control-area, #main-navigation{
