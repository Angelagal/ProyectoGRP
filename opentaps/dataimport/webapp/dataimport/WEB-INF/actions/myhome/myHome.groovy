...
modifoProcessed = delegator.findCountByCondition("DataImportModifo", allConditions, null);
...
modifoNotProcessed = delegator.findCountByCondition("DataImportModifo", statusCond, null);
...
context.put("modifoProcessed", modifoProcessed);
context.put("modifoNotProcessed", modifoNotProcessed);
